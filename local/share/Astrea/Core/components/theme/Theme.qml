...
Item {
    ...
    function applyConfig(cfg) {
        ...
        theme.themeMode = cfg.theme_mode === 1 ? 1 : 0
    ...
    readonly property color cardBg: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(1, 1, 1, 0.74) : Qt.rgba(1, 1, 1, 0.08)
    ...
    readonly property color cardBorder: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(0, 0, 0, 0.12) : Qt.rgba(1, 1, 1, 0.12)
    ...
    readonly property color popupBg: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(0.98, 0.98, 1.0, 0.98) : Qt.rgba(0.12, 0.12, 0.14, 0.98)
    ...
    readonly property color windowBackground: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(0.95, 0.96, 0.99, 0.92) : Qt.rgba(0.10, 0.10, 0.12, 0.90)
    ...
    readonly property color windowBorder: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(0, 0, 0, 0.12) : Qt.rgba(1, 1, 1, 0.14)
        return themeMode === 1 ? Qt.rgba(0, 0, 0, 0.10) : Qt.rgba(1, 1, 1, 0.08)
    }
    readonly property color windowWash: {
        ...
        if (shellStyle === 2)
            return themeMode === 1 ? Qt.rgba(1, 1, 1, 0.20) : Qt.rgba(1, 1, 1, 0.05)
