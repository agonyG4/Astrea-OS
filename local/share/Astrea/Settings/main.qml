...
ApplicationWindow {
    ...
    readonly property var pages: [
        ...
        "pages/display.qml",
        "pages/apps.qml",
        "pages/performance.qml",
        "pages/wifi.qml",
        "pages/bluetooth.qml",
        "pages/personalization.qml",
        "pages/wallpaper.qml",
        "pages/audio.qml"
    ]
    ...
    ListModel {
        id: navModel
        ListElement { label: "System";          sym: "\uf303" } // nf-linux-archlinux
        ListElement { label: "Display";         sym: "\uf108" } // nf-fa-desktop
        ListElement { label: "Apps";            sym: "\uf00a" } // nf-fa-th
        ...
        ListElement { label: "Personalization"; sym: "\uf53f" } // nf-fa-palette
        ListElement { label: "Wallpaper";       sym: "\uf03e" } // nf-fa-picture_o
        ListElement { label: "Audio";           sym: "\uf028" } // nf-fa-volume_up
    }
    ...
    Loader {
        ...
        onStatusChanged: {
            if (status === Loader.Ready) {
                ...
                // Conecta o signal navigateTo se a página tiver
                if (item && item.hasOwnProperty("navigateTo")) {
                    item.navigateTo.connect(function(page) {
                        if (page === "lockscreen")
                            pageLoader.setSource("pages/lockscreen.qml")
                        else if (page === "screensaver")
                            pageLoader.setSource("pages/screensaver.qml")
                    })
                }
            }
        }
