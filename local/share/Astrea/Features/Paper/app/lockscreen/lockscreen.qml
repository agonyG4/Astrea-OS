...
ShellRoot {
    ...
    readonly property string wallpaperDir: "file://" + homeDir + "/.local/share/Astrea/Features/Paper/state/lockscreen/"

    Process {
        id: authProcess
        command: [homeDir + "/.local/share/Astrea/Features/Paper/app/lockscreen/auth_helper", root.currentUser, passwordField.text]
        running: false
