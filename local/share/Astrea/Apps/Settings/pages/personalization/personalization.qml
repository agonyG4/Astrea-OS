...
Item {
    ...
    property int selectedIconStyle:  Theme.iconStyle
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    delegate: Item {
                                        required property var modelData
                                        required property int index
                                        readonly property bool active: root.selectedIconStyle === modelData.value
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                root.selectedIconStyle = parent.modelData.value
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Repeater {
                                model: [
                                    "file:///home/agony/.local/share/Astrea/icons/settings/display.svg",
                                    "file:///home/agony/.local/share/Astrea/icons/settings/network.svg",
                                    "file:///home/agony/.local/share/Astrea/icons/settings/bluetooth.svg",
                                    "file:///home/agony/.local/share/Astrea/icons/settings/audio.svg"
                                ]
                                delegate: Image {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Repeater {
                                model: [
                                    { key: "display",   src: "file:///home/agony/.local/share/Astrea/icons/settings/icon/dark/display.svg"   },
                                    { key: "network",   src: "file:///home/agony/.local/share/Astrea/icons/settings/icon/dark/network.svg"   },
                                    { key: "bluetooth", src: "file:///home/agony/.local/share/Astrea/icons/settings/icon/dark/bluetooth.svg" },
                                    { key: "audio",     src: "file:///home/agony/.local/share/Astrea/icons/settings/icon/dark/audio.svg"     }
                                ]
                                delegate: Image {
                                    required property var modelData
                                    width: 22; height: 22
                    ...
                    MouseArea {
                        anchors.fill: parent
                        cursorShape: Qt.PointingHandCursor
                        onClicked: Theme.iconTheme = "dark"
                    }
                }
            }
        }
