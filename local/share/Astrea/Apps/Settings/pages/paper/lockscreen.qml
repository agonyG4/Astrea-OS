...
Item {
    ...
    readonly property string _sharedBase: Quickshell.env("HOME") + "/.local/share/Astrea/Features/Paper"
    readonly property string _scripts: Quickshell.env("HOME") + "/.local/share/Astrea/System/scripts/wallpaper"
    readonly property string _base:       _sharedBase + "/state/lockscreen"
    readonly property string wpFull:      _base + "/wallpaper.jpg"
    readonly property string wpName_f:    _base + "/wallpaper_name.txt"
    readonly property string userDir:       _sharedBase + "/library/user"
    readonly property string dynamicDir:    _sharedBase + "/library/dynamic"
    readonly property string landscapesDir: _sharedBase + "/library/landscapes"
