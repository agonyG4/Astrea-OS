...
ScrollPage {
    ...
    ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ToggleSwitch {
                        ...
                        onToggled: {
                            btPowerProc.turnOn = !root.powered
                ...
                Text {
                    text: "Este Astrea pode ser encontrado como \"" + root.adapterName + "\" enquanto os Ajustes de Bluetooth estiverem abertos."
                    color: Theme.textSecondary
                    font.pixelSize: 12
                    font.family: Theme.fontFamily
                    opacity: 0.7
        ...
        FormCard {
            Text {
                visible: root.scannedDevices.length === 0 && !root.scanning
