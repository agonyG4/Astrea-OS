...
ShellRoot {
    ...
    readonly property string wallpaperDir: "file://" + homeDir + "/.local/share/Astrea/System/Paper/LockscreenWallpaper/"

    Process {
        id: authProcess
        command: [homeDir + "/.local/share/Astrea/System/Paper/Lockscreen/auth_helper", root.currentUser, passwordField.text]
        running: false
