...
USER_WP_DIR = BASE_DIR / "library/user"
LOCKSCREEN_WP_DIR = BASE_DIR / "state/lockscreen"
WP_THUMB_SRC = BASE_DIR / "state/wallpaper/wallpaper.jpg"
WP_THUMB_DEST = BASE_DIR / "state/wallpaper/wallpaper_thumb.jpg"
