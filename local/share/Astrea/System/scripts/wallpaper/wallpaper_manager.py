...
BASE_DIR = Path.home() / ".local/share/Astrea/Features/Paper"
LIBRARY_DIRS = {
    "user": BASE_DIR / "library/user",
    "dynamic": BASE_DIR / "library/dynamic",
    "landscapes": BASE_DIR / "library/landscapes",
}
STATE_DIRS = {
    "wallpaper": BASE_DIR / "state/wallpaper",
    "lockscreen": BASE_DIR / "state/lockscreen",
}
TRANSITIONS = [
    "simple",
    "fade",
...
TRANSITION_FILE = BASE_DIR / "state/wallpaper_transition.txt"
