...
ScrollPage {
    ...
    readonly property string scriptPath: (Quickshell.env("HOME") || "") + "/.local/share/Astrea/Core/bridge/system.py"
    readonly property string logoPath: (Quickshell.env("HOME") || "") + "/.local/share/Astrea/Assets/Astrea/Astrea_logo.png"
