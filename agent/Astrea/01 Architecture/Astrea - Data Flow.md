...
7. If INMET alerts exist and notifications are enabled, `WeatherState` calls the bridge notification action.
8. The bridge deduplicates alerts and sends desktop notifications with `notify-send`.
