...
BUS_NAME = "org.freedesktop.impl.portal.desktop.bench"
OBJECT_PATH = "/org/freedesktop/portal/desktop"
INTERFACE = "org.freedesktop.impl.portal.FileChooser"
RESULT_PREFIX = "__BENCH_FILE_DIALOG__"
QSLOG_PATH_PATTERN = re.compile(r'Saving logs to "([^"]+log\.qslog)"')
PORTAL_DIALOG_QML = "/home/agony/GitHub/Bench/Explorer/PortalDialog.qml"
QS_BIN = "/usr/bin/qs"
RESPONSE_SUCCESS = dbus.UInt32(0)
RESPONSE_CANCELLED = dbus.UInt32(1)
DEBUG_LOG = Path("/tmp/bench_filechooser_portal.log")
DEBUG_ENABLED = os.environ.get("BENCH_FILECHOOSER_DEBUG") == "1"
...
def run_dialog(mode, title, options):
    ...
    result_file = tempfile.NamedTemporaryFile(
        prefix="bench_file_dialog_result_",
        suffix=".json",
        dir="/tmp",
        delete=False,
    )
    ...
    result_file.close()
    env["BENCH_FILE_DIALOG_OPTIONS"] = json.dumps(
        {
            "mode": mode,
            "title": title or "",
...
class BenchFileChooser(dbus.service.Object):
