...
PanelWindow {
    ...
    WlrLayershell.namespace: "bench-notifications"
    WlrLayershell.layer: WlrLayer.Overlay
    WlrLayershell.exclusiveZone: -1

    property string stateUrl: Qt.resolvedUrl("state.json")
    ...
    function loadState() {
        ...
        request.open("GET", stateUrl + "?t=" + Date.now())
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                radius: 22
                color: urgency >= 2 ? Qt.rgba(0.22, 0.06, 0.045, 0.92) : Qt.rgba(0.06, 0.065, 0.075, 0.92)
                border.color: urgency >= 2 ? Qt.rgba(1.0, 0.38, 0.24, 0.42) : Qt.rgba(1, 1, 1, 0.14)
                border.width: 1
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.alignment: Qt.AlignTop
                        radius: 12
                        color: closeArea.containsMouse ? Qt.rgba(1, 1, 1, 0.14) : "transparent"
