...
Window {
    ...
    Process { id: cmdPlayPause; command: ["spotify_player", "playback", "play-pause"]; running: false }
    Process { id: cmdNext; command: ["spotify_player", "playback", "next"]; running: false }
    Process { id: cmdPrev; command: ["spotify_player", "playback", "previous"]; running: false }
