...
Item {
    ...
    readonly property var columns: [
        ...
        { label: ((AstreaI18n.I18n.messages && AstreaI18n.I18n.messages["apps.explorer.components.views.file_list_view.label.data_de_modificaaao"]) || "Modification Date"), field: "date", flex: 1.5 },
